        ...
        if (c == 0 and len(purchased) == 0) or c > 50:
            if total_money / both_money > 0.1:
                if current_date > date1:
                    founded = find_something(4.0, 5000, 3000, reduced_stocks2)
                elif current_date > date2:
                    founded = find_something(4.0, 5000, 3000, reduced_stocks1)
                elif current_date > date4:
                    if total_money / both_money > 0.2:
                        founded = find_something(4.0, 5000, 3000)    
                elif current_date > date5:
                    if total_money / both_money > 0.5:
                        founded = find_something(1.5, 1000, 800)
